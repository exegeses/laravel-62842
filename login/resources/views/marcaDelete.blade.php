        ...
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h1 class="pb-6">Baja de una marca</h1>

                    <form action="/marca/destroy/{{ $marca->idMarca }}" method="post">
                    @method('delete')
                    @csrf
                        <div class="relative z-0 w-full mb-6 group">
                            <span type="text" name="mkNombre" id="mkNombre" class="block py-2.5 px-0 w-full text-2xl text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-teal-400 dark:border-gray-600 dark:focus:border-teal-500 focus:outline-none focus:ring-0 focus:border-teal-600 peer"
                                  >{{ $marca->mkNombre }}</span>
                        </div>
